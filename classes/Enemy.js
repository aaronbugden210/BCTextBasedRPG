class Enemy extends Person
{
    chooseType()
    {
        var enemyTypes = [{name: "CyberImp", hp: 100, mp: 20, atk: 15, df: 20},
                          {name: "Blob", hp: 80, mp: 0, atk: 25, df: 20},
                          {name: "CyberDog", hp: 90, mp: 0, atk: 30, df: 20}];
        ...
        switch(rand)
        {
            case 0:
                ...
                this.maxHp = this.hp;
                this.maxMp = this.mp;
                console.log(this.name, this.hp, this.mp, this.atk, this.df);
                break;
            case 1:
